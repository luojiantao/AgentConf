...
type AgentFrontmatter = {
	...
	tools?: unknown;
	model?: unknown;
	continuationCommand?: unknown;
	completionMarker?: unknown;
	blockedMarker?: unknown;
};
...
function loadAgentsFromDir(dir: string, source: "user" | "project"): AgentConfig[] {
	...
	for (const entry of entries) {
		...
		agents.push({
			...
			continuationCommand:
				typeof frontmatter.continuationCommand === "string" ? frontmatter.continuationCommand : undefined,
			completionMarker: typeof frontmatter.completionMarker === "string" ? frontmatter.completionMarker : undefined,
			blockedMarker: typeof frontmatter.blockedMarker === "string" ? frontmatter.blockedMarker : undefined,
			systemPrompt: body,
			source,
			filePath,
		});
